...
//         <div onClick={toggleNav} className="md:hidden absolute top-5 right-5 text-white/70 border-white/70 p-2 z-50">
...
//        className="fixed left-0 top-0w-full z-40 bg-black/90"
//        >
...
const Navbar = () => {
  ...
  return (
    <div className="bg-gradient-to-t from-pink-400 to-purple-500">
        ...
        <ul className="flex flex-row p-4 space-x-8">
          ...
          <li>
            <a href="/contact" className="group">
              ...
              <h1 className="text-lg font-bold text-white/70 cursor-pointer"><Link href="/Contact">
                Contact Me
              </Link>
              </h1>
              <div className="relative">
